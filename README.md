...
git clone https://github.com/IvorySnake02/SAG.git
cd SAG
...
# Load the GunPoint dataset from aeon using our function
...
# Create a data loader for SAG (using test data)
...
```python
from SAG import ICMLA_results

# Reproduce results for GunPoint dataset
...
This work uses datasets from the [UCR Time Series Classification Archive](https://www.timeseriesclassification.com/) accessed through the [aeon](https://www.aeon-toolkit.org/) toolkit.
...
@inproceedings{ibarra2025SAG,
  ...
  author={Ibarra, Sal and Cantu, [First Name] and Zhou, Kaixiong and Zhang, [First Name]},
